...
/**
 * @title MetaBillionaireUtilityCoin
...
contract MetaBillionaireUtilityCoin is ERC20 {
     ...
     * @param maxTotalSupply total supply of tokens in lowest units (depending on decimals)
     */
    constructor(string memory tokenName, string memory tokenSymbol, uint8 tokenDecimals, uint256 maxTotalSupply) {
      _name = tokenName;
      _symbol = tokenSymbol;
